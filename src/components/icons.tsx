...
export const InstagramIcon = (props: IconType) => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9 114.9-51.3 114.9-114.9-51.3-114.9-114.9-114.9zm0 186.6c-39.6 0-71.7-32.1-71.7-71.7s32.1-71.7 71.7-71.7 71.7 32.1 71.7 71.7-32.1 71.7-71.7 71.7zm146.4-194.3c0 14.9-12 26.9-26.9 26.9s-26.9-12-26.9-26.9 12-26.9 26.9-26.9 26.9 12 26.9 26.9zm76.1 27.2c-1.7-35.7-9.9-67.3-36.3-92.7s-57-34.6-92.7-36.3c-36.5-2.1-146-2.1-182.5 0-35.7 1.7-67.3 9.9-92.7 36.3s-34.6 57-36.3 92.7c-2.1 36.5-2.1 146 0 182.5 1.7 35.7 9.9 67.3 36.3 92.7s57 34.6 92.7 36.3c36.5 2.1 146 2.1 182.5 0 35.7-1.7 67.3-9.9 92.7-36.3s34.6-57 36.3-92.7c2.1-36.5 2.1-146 0-182.5zm-48.6 224.1c-7.8 19.7-22.9 34.8-42.6 42.6-29.5 11.7-99.5 9-132.8 9s-103.3 2.6-132.8-9c-19.7-7.8-34.8-22.9-42.6-42.6-11.7-29.5-9-99.5-9-132.8s-2.6-103.3 9-132.8c7.8-19.7 22.9-34.8 42.6-42.6 29.5-11.7 99.5-9 132.8-9s103.3-2.6 132.8 9c19.7 7.8 34.8 22.9 42.6 42.6 11.7 29.5 9 99.5 9 132.8s2.6 103.3-9 132.8z"></path>
  </svg>
);
