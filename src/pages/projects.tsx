...
export default function Projects() {
  return (
    <>
      <NextSeo
        title="Projects by Tanishq Raj - Full Stack Dev"
        description="Explore a collection of projects by Tanishq Raj, a Developer. From innovative web applications to responsive interfaces."
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mx-auto mt-16 max-w-5xl text-center text-foreground md:mt-28">
            <span className="text-xl font-bold md:text-2xl">
              I am currently building new projects and learning different Tech Stacks in the field of Web Dev to expand my skill set.
            </span>
